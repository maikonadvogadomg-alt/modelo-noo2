    ...
    <View style={{ flex: 1, backgroundColor: BG }}>
      ...
      <View style={[s.header, { paddingTop: Platform.OS === 'web' ? 54 : insets.top + 8 }]}>
        <View style={s.headerLeft}>
          ...
          <View>
            <Text style={s.headerTitle}>ConfiguraÃ§Ãµes</Text>
            <Text style={s.headerSub}>Configure seus perfis de IA e integraÃ§Ãµes</Text>
          </View>
        </View>
      </View>
      ...
      >
        ...
        <Block>
          ...
          <Label>Chave de API â {PROVIDERS[editingProfile.provider]?.name}</Label>
          <ApiKeyRow
          ...
          {/* Modelo */}
          <Label>Modelo <Text style={{ color: MUTED, fontSize: 11 }}>(deixe vazio para automÃ¡tico)</Text></Label>
          <View style={s.modelRow}>
            <TextInput
              style={s.modelInput}
              value={localModel}
              onChangeText={setLocalModel}
              placeholder="AutomÃ¡tico (deixe vazio)"
          ...
          <View style={{ flexDirection: 'row', gap: 8, marginTop: 12 }}>
            ...
            >
              ...
              <Text style={[s.saveProfileBtnText, { color: savedBadge === 'profile-' + editingProfileId ? SUCCESS : MUTED }]}>
                {savedBadge === 'profile-' + editingProfileId ? 'Salvo!' : 'Salvar alteraÃ§Ãµes'}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              return (
                <View key={key} style={s.keyItem}>
                  ...
                  <Text style={[s.keyVal, { color: hasKey ? '#3fb950' : '#484f58' }]} numberOfLines={1}>
                    {hasKey ? k!.slice(0, 8) + '...' : 'nÃ£o configurada'}
                  </Text>
                </View>
              );
            })}
        ...
        <Block>
          ...
          <View style={{ gap: 10, marginTop: 10 }}>
            {[
              { label: 'Nome completo', value: profileNome, set: setProfileNome, placeholder: 'Dr. JoÃ£o Silva' },
              ...
              { label: 'Tribunal / Comarca', value: profileTribunal, set: setProfileTribunal, placeholder: 'TJSP â Comarca de SÃ£o Paulo' },
              { label: 'Cidade / Estado', value: profileCidade, set: setProfileCidade, placeholder: 'SÃ£o Paulo â SP' },
            ].map((f) => (
              <View key={f.label}>
                <Label>{f.label}</Label>
                <TextInput
        ...
        <Block>
          ...
          <View style={{ gap: 10, marginTop: 6 }}>
            {[
              ...
              { label: 'UsuÃ¡rio / OrganizaÃ§Ã£o', value: ghOwner, set: setGhOwner, secure: false, placeholder: 'meu-usuario' },
              { label: 'RepositÃ³rio', value: ghRepo, set: setGhRepo, secure: false, placeholder: 'meu-repo' },
        ...
        <Block>
          ...
          {neonInput.startsWith('postgresql') && (
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 8 }}>
              ...
              <Text style={{ fontSize: 12, color: SUCCESS }}>ConexÃ£o configurada</Text>
            </View>
          )}
          <Text style={[s.hint, { marginTop: 8 }]}>
            Obtenha a URL em console.neon.tech â seu projeto â Connection Details
          </Text>
        </Block>
        ...
        <Block>
          ...
          <Text style={s.hint}>Valores altos usam mais crÃ©ditos de API. "MÃ¡x" forÃ§a o limite mÃ¡ximo do modelo.</Text>
        </Block>
        ...
        <Block>
          ...
          <Label>Idioma de transcriÃ§Ã£o</Label>
        ...
        <View style={s.statusFooter}>
          ...
          <Text style={[s.statusFooterText, { color: '#484f58' }]}>Â·</Text>
