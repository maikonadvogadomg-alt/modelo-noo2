...
const SYSTEM_PROMPT =
  'Voc̻ ̩ um assistente IA inteligente, criativo e prestativo. Responda de forma natural, clara e ̼til. Use portugu̻s do Brasil.';
      ...
      {!isConfigured && (
        <View style={[styles.warning, { backgroundColor: colors.warning + '22', borderColor: colors.warning }]}>
          ...
          <Text style={[styles.warningText, { color: colors.warning }]}>
            Configure sua chave de API em Configura̵̤es
          </Text>
        </View>
      )}
