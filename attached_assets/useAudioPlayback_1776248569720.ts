 ...
 * - seq 2 arrives Ã¢ÂÂ buffered (waiting for seq 0)
 * - seq 0 arrives Ã¢ÂÂ played immediately, then check buffer
 * - seq 1 arrives Ã¢ÂÂ played immediately (seq 0 done), seq 2 now plays
 */
